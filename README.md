...
- To run this service in production, let's assume it will run as an Unbuntu service. For this we need a binary that watches a particular Kubernetes config. 
